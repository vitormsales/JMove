package br.ufmg.dcc.labsoft.java.jmove.actions;
...
public class Menu implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		try {
			if(action.getId().equals("br.ufmg.dcc.labsoft.java.jmove.actions.FeatureEnvy")) {
				page.showView("jmove_beta.views.SampleView");
			}
